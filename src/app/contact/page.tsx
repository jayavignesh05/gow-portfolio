          ...
          >
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full border-b border-neutral-200 py-3 outline-none transition-colors focus:border-black"
            ...
            <div>
              ...
              <textarea
                id="message"
                rows={4}
                className="w-full resize-none border-b border-neutral-200 py-3 outline-none transition-colors focus:border-black"
            ...
            <button
              type="submit"
              className="mt-8 w-full rounded-full bg-black py-4 font-medium text-white transition-transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Send Message
            </button>
          </motion.form>
