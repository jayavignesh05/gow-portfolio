          ...
          <div className="grid grid-cols-1 gap-16 md:grid-cols-2">
            ...
            >
              ...
              <p className="mb-8 text-lg text-neutral-500">
                I am a photographer based in Berlin with a passion for capturing
                the beauty in the ordinary. My work is driven by a desire to
                tell stories through visual imagery, focusing on light,
                composition, and emotion.
              </p>
              <p className="mb-12 text-lg text-neutral-500">
                With over 10 years of experience, I have worked with brands and
                individuals worldwide to create compelling visual narratives
                that resonate.
              </p>
              ...
              <a
                href="/contact"
                className="inline-flex items-center gap-2 text-lg font-medium text-black hover:text-neutral-600"
              >
