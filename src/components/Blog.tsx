  ...
  const articles = [
    {
      ...
      excerpt:
        "Learn how to use natural light to create stunning, professional-quality photographs.",
      icon: Lightbulb,
    ...
    },
    {
      ...
      excerpt:
        "Essential composition techniques that every photographer should know.",
      icon: Camera,
    ...
    },
    {
      ...
      excerpt:
        "Transform your photos with professional color grading and editing techniques.",
      icon: Palette,
